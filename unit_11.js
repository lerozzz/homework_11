...
function f11() {
    ...
    console.log(Array.isArray(d11));
    document.querySelector('.out-11').innerHTML = d11.indexOf(+input);
}
...
let t13 = [];
function f13() {
    lastIndex = d13.length - 1;
    for (let index = 0; index < d13.length; index++) {
        t13[index] = d13[lastIndex];
        lastIndex--;
    }
    d13 = t13
    showArr('.out-13', d13);
...
function f18() {
    ...
    out.innerHTML = d18.includes(input);
}
